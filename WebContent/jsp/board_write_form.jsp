...
<link href="static/css/summernote-bs2.css" rel="stylesheet"
	type="text/css">
		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<form action="boardAdd.do">
				<div class="col-sm-9">
					...
					</select> <input type="hidden" name="writer_id"
						value="<%=LoginInfo.getUser_id()%>"> <br> <br> <input
						type="text" class="form-control title" name="title"> <br>
					<div id="summernote"></div>
					<br>
					<br> <input type="file" class="file" /> <br>
					<div class="col-md-3 col-md-offset-9">
						<input type="checkbox" name="anonymous" class="checkbox inline"
							value="ANONYMOUS" /> <span class="text inline">익명</span> <input
							type="checkbox" name="closed" class="checkbox inline"
							value="CLOSED" /> <span class="text inline">비밀글</span>
