	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9">
				...
				<br> <input type="text" class="form-control title" name="title">
				<br>
				<textarea rows="20" cols="135">
	         
	      </textarea>
				<br> <br> <input type="file" class="file" /> <br>

				<div class="col-md-3 col-md-offset-9 ">
					<input type="checkbox" class="checkbox inline" /> <span
						class="text inline">익명</span> <input type="checkbox"
						class="checkbox inline" /> <span class="text inline">비밀글</span>
