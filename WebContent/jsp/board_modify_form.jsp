		...
		<div class="row row-offcanvas row-offcanvas-left">
	        ...
	        <%=vo.getContents() %>
					...
					<div class="col-md-3 col-md-offset-9 ">
						...
						<span class="text inline">익명</span> <input type="checkbox"
							name="closed" class="checkbox inline" /> <span
							class="text inline">비밀글</span>
