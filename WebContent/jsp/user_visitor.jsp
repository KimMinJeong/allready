...
<body>
	<div class="container">
		<div class="col-md-5 col-md-offset-7">
			<form action="addVisitor.do" class="navbar-form navbar-left"
				method="post">
		...
		<div class="col-md-4 col-md-offset-7 ">
			...
			<div class="input-group">
				<span class="input-group-addon">이름</span> <input type="text"
					class="form-control" placeholder="이름" name="visitor_name">
			</div>

			<div class="input-group">
				<span class="input-group-addon">용무</span> <input type="text"
					class="form-control" placeholder="용무" name="business">
			</div>
		</div>
		<br> <br> <br> <br>
						...
						<tr>
							...
							<td><center>
									<button type="submit" class="btn btn-primary" name="name"
										value="<%=vo.getVisitor_no()%>">삭제</button>
								</center></td>
						</tr>
						<%
							}
